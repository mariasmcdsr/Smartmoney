    ...
    <?php if ($buscaItens != "") { ?>
        <div class="resumo-busca">
            ...
            <?php if ($tipoItem == "todos" || $tipoItem == "receitas") { ?>
                Receitas encontradas: <?php echo count($receitasLista); ?> | Total: R$ <?php echo number_format($totalReceitasFiltradas, 2, ',', '.'); ?><br>
            <?php } ?>
            <?php if ($tipoItem == "todos" || $tipoItem == "gastos") { ?>
                Gastos encontrados: <?php echo count($gastosLista); ?> | Total: R$ <?php echo number_format($totalGastosFiltrados, 2, ',', '.'); ?>
            <?php } ?>
        </div>
    <?php } ?>

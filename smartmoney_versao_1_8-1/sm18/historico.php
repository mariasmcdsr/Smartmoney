    ...
    <?php if ($busca != "") { ?>
        <div class="resumo-busca">
            ...
            <?php if ($tipoBusca == "todos" || $tipoBusca == "gastos") { ?>
                Gastos encontrados: <?php echo $qtdGastosBusca; ?> | Total: R$ <?php echo number_format($totalGastosBusca, 2, ',', '.'); ?><br>
            <?php } ?>
            <?php if ($tipoBusca == "todos" || $tipoBusca == "receitas") { ?>
                Receitas encontradas: <?php echo $qtdReceitasBusca; ?> | Total: R$ <?php echo number_format($totalReceitasBusca, 2, ',', '.'); ?>
            <?php } ?>
        </div>
    <?php } ?>
